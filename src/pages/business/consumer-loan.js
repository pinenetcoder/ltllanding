        ...
        <main>
                ...
                <div className={styles.stepsList}>
                  <div className={styles.stepsItem}>
                      ...
                      <div className={styles.stepsText}>
                        <h2 className={styles.stepsTitle}>{t.consumerLoan.stepProcess.step1.title}</h2>
                        <div className={styles.stepsDescription}>
                            {t.consumerLoan.stepProcess.step1.description}
                        </div>
                      </div>
                  </div>
                  <div className={styles.stepsItem}>
                      ...
                      <div className={styles.stepsText}>
                        <h2 className={styles.stepsTitle}>{t.consumerLoan.stepProcess.step2.title}</h2>
                        <div className={styles.stepsDescription}>
                            {t.consumerLoan.stepProcess.step2.description}
                        </div>
                      </div>
                  </div>
                  <div className={styles.stepsItem}>
                      ...
                      <div className={styles.stepsText}>
                        <h2 className={styles.stepsTitle}>{t.consumerLoan.stepProcess.step3.title}</h2>
                        <p>{t.consumerLoan.stepProcess.step3.subTitle}</p>
                        <div className={styles.stepsDescription}>
                            <ul>
                              <li>{t.consumerLoan.stepProcess.step3.bulletBlock.bullet1}</li>
                              <li>{t.consumerLoan.stepProcess.step3.bulletBlock.bullet2}</li>
                              <li>{t.consumerLoan.stepProcess.step3.bulletBlock.bullet3}</li>
                            </ul>
                        </div>
                      </div>
                  </div>
                  <div className={styles.stepsItem}>
                      ...
                      <div className={styles.stepsText}>
                        <h2 className={styles.stepsTitle}>{t.consumerLoan.stepProcess.step4.title}</h2>
                        <div className={styles.stepsDescription}>
                            {t.consumerLoan.stepProcess.step4.description}
                        </div>
                      </div>
                  </div>
                  <div className={styles.stepsItem}>
                      ...
                      <div className={styles.stepsText}>
                        <h2 className={styles.stepsTitle}>{t.consumerLoan.stepProcess.step5.title}</h2>
                        <div className={styles.stepsDescription}>
                            {t.consumerLoan.stepProcess.step5.description}
                        </div>
                      </div>
                  </div>
                </div>
          ...
          <section id="clientSuport" className={styles.clientSuportSection}>
            <div className={styles.clientSuportWrapper}>
                <h3 className={styles.clientSuportHeader}>{t.consumerLoan.clientSuport.title}</h3>
