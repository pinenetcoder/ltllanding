...
export default {
  ...
  indexPage: {
    slideOne: {
      ...
      heroBlockText: 'Su Kocomo namas bendrai priklauso ne daugiau kaip aštuonioms šeimoms o mes veikiame kaip neutralus trečiosios šalies administratorius, siekdami užtikrinti skaidrumą ir sąžiningumą',
  ...
  licence: {
    pageTitle: "Licencija",
    description: "Juridiniu pavadinimu LTL Kredito unija veikianti įmonė yra registruota Lietuvoje (įm. kodas 302791356) ir teikia licencijuotas paslaugas bei veikla prižiūrima Lietuvos banko (licencijos Nr. 80)."
  },
  termConditions: {
  ...
  termDeposit: {
    heroBlock: {
      title: "Terminuotas indėlis: Nebereikia būti dideliam, kad užsidirbtumėte turtus/jūsų turtas augtų",
  ...
  openBanking: {
    ...
    heroBlock: {
      description: "Mūsų atviros bankininkystės technologija sukurta siekiant pagerinti bendrą banko patirtį. Naudodamos modernią API sąsają, įmonės gali kurti pažangiausias aplikacijas, kurios yra lengvai naudojamos ir puikiai integruotos su banko paslaugomis.",
